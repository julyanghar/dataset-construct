...
if __name__ == "__main__":
    ...
    input_path = "/home/yilin/dataset-construct/yilin-DPO-dataset/re-align/yilin_pref_data_pooler_output.json"   # 👈 你的原始文件
    output_path = "/home/yilin/dataset-construct/yilin-DPO-dataset/re-align/proc_pooler_output.json" # 👈 转换后的目标文件
